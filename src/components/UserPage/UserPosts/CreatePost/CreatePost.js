    ...
    return (
        <div className='create_post'>
            <div className="create_post_form">
                ...
                <input type="text" placeholder='Загаловок' onChange={(e)=>setPostTitle(e.target.value)}/>
            
                <textarea name="" id="" cols="30" rows="10" onChange={(e)=>setPostText(e.target.value)}/>
            ...
            <div className="tags">
                    <input value='programming' className='tagsinp' type="checkbox" id='programming' name='tags' /> <label htmlFor="programming">Программирование</label>
                    <input value='marketing' className='tagsinp' type="checkbox" id='marketing' name='tags' /> <label htmlFor="marketing">Маркетинг</label>
                    <input value='story' className='tagsinp' type="checkbox" id='story' name='tags' /> <label htmlFor="story">Личная история</label>
