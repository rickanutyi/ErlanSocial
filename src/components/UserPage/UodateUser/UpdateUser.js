...
const UpdateUser = () => {
  const { updateUser, getMainUser, mainUser } = useContext(usersContext);
  ...
  return (
    <div className="update_user">
      <div className="change_users_photo">
        ...
        <label htmlFor="file" className="label_change">
          <img src={ReplacePhoto} />
          <br /> изменить аватарку
        </label>
      </div>
      <div className="change_name">
        <input
          type="text"
          value={usern.name}
          onChange={(e) => setUser({ ...usern, name: e.target.value })}
        />
      </div>
      <div className="save_updates">
